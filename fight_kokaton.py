...
class Score:
    ...
    def __init__(self):
        ...
        self.rct = self.img.get_rect()  # ビーム座標取得
...
class Beam:
    ...
    def __init__(self, bird:"Bird"):
        ...
        self.rct = self.img.get_rect()  # ビーム座標取得
        self.rct.centery = bird.rct.centery  # ビームをトリの中心からに設定
        self.rct.left = bird.rct.right  # こうかとんの右座標設定
        self.vx, self.vy = +5, 0
...
def main():
    ...
    while True:
        ...
        for bomb in bombs:
            if bird.rct.colliderect(bomb.rct):  # 爆弾にぶつかった処理
